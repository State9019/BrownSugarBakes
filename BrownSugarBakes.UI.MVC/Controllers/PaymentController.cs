...
namespace BrownSugarBakes.UI.MVC.Controllers
{
    public class PaymentController : Controller
    {
        ...
        //Create payment using an APIContext
        private Payment CreatePayment(APIContext apiContext, string redirectUrl)
        {
            ...
            //List<Models.Home.Location> sc = (List<Models.Home.Location>)Session["shipCart"];
            ...
            //        line1 = item.ShipInfo.Address.ToString(),
            //        city = item.ShipInfo.City.ToString(),
            //        state = item.ShipInfo.State.ToString(),
            //        postal_code = item.ShipInfo.ZipCode.ToString(),
            //        country_code = item.ShipInfo.Country.ToString()
            ...
            // Do the configure Redirect Urls here with RedirectUrls object  
            ...
            var details = new Details()
            {
                tax = "1",
                shipping = "1",
                subtotal = cart.Sum(item => item.Quantity * item.Product.Price).ToString()
            };
